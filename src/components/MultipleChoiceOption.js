...
const MultipleChoiceOption = ({ onPress, isSelected, textKey }) => (
  <TouchableOpacity onPress={onPress}>
    <Box p={3} mb="2px" position="relative">
      <Box position="absolute" bg={isSelected ? 'settingsSelected' : 'settingsUnselected'} top={0} bottom={0} left={0} right={0} />
      <LScript fontSize={2} color={isSelected ? 'accent' : 'settingsText'} textKey={textKey} />
    </Box>
  </TouchableOpacity>
);
